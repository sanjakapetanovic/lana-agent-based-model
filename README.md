...
Repository:
Kapetanović S, Dželalija M, Bijedić N, Gašpar D, Tipurić-Spužević S. (2026). Zenodo. (https://doi.org/10.5281/zenodo.19085845)

Associated manuscript:
Kapetanović S, Dželalija M, Bijedić N, Gašpar D, Tipurić-Spužević S. (2026). *A Rule-Based Agent-Based Neural Model with Explicit Signal Transport and Environment-Mediated Feedback: The LANA Model*.
